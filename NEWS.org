...
+ Bug fixes to diredc shell windows
  ...
  + properly initialize all pre-defined shell variables for all shell
    options, including eshell.

+ When the current diredc directory is deleted from outside of diredc,
...
+ Improve opening options for executable files.
** 2025-08
